...
var TRbgColor = "#C5DDFE";
	...
	try
	{
		...
		$("addframe").src="<%=request.getContextPath()%>/itil/accesscontrol/operate/monitor_detail.jsp?id="+selectedTR.codeid;
	}
	catch(e)
	{
		alert("请选取有效代码！");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
  <tr> 
    <td width="81%" height="24" valign="top" class="url"><img src="<%=request.getContextPath()%>/themes/common/img/icons/icon01.gif" />&nbsp;您当前的位置：系统管理 - 权限管理 - 在线人员</td>
    <td width="19%" align="right"><input name="list" value="列表显示" class="button" type="button" onClick="location.href='<%=request.getContextPath()%>/itil/accesscontrol/monitor_list.jsp'"></td>
  </tr>
</table>
...
<div style="overflow:auto; width:300px; height:500px" id=divBox>
...
%>
		  ...
		  <td width="70%" align="center" valign="top">
			<iframe src="<%=request.getContextPath()%>/itil/accesscontrol/operate/operatehelp.jsp" name="addframe" width="100%" height="500" align="top" scrolling="auto" frameborder="0"></iframe>
		  </td>
        </tr>
      </table>
	</td>
...
%>
	...
	function getChildren(list,pos){
		...
		url=this.location.href.replace("monitor.jsp","select/departselectorXml.jsp");

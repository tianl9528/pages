...
try
{
	...
	List list=pagination.getList(manager.readRoleDepart(departId,roleId),20,request);
	session.removeAttribute("sys_role_departsearch");
%>
<html>
<head>
<title>部门成员一览</title>
...
<table width="100%" align="center" cellpadding="3" cellspacing="0">
      <tr>
		<td width="77%" height="30" valign="top" class="url"><img src="<%=request.getContextPath()%>/themes/common/img/icons/icon01.gif" />&nbsp;您当前的位置：权限管理 - 角色管理 - 部门成员一览</td>
        ...
        <input name="button22" type="button" class="button" onClick="window.navigate('role_list.jsp')" value="返回">        </td>
      </tr>
</table>
...
<form name="thisForm" action="role_member_depart_search.jsp" method="post">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
        	<td width="60%" height="25">&nbsp;&nbsp;角色名：<%=role.getName()%></td>
          	<td width="40%" align="right">
          		<a href="role_member_user.jsp?id=<%=roleId%>">用户成员</a>
          		&nbsp;&nbsp;&nbsp;&nbsp;
                <font color="#FF6600">部门成员</font>
          		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
      </table>

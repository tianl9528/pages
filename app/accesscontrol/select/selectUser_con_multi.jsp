...
<form name="accessForm" action="selectUser_con_multi.jsp" method="post">
...
<%	    
	...
	%>
        <tr onMouseOver="if (this.className!='trSelect') this.className='trOver'" 
          ...
          <td><input type="checkbox" name="userId" id="<%=dat.getUserID()%>"  nameVal="<%=dat.getUser_name()%>" value="<%=dat.getUserID()%>"  onClick="checkBoxClick(this)"></td>

...
function showSelect(){
	...
	document.getElementById("selectUser").src="selectUser_con.jsp"+viewSel;
}
...
<iframe id="selectUser" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" scrolling="no" src="selectUser_con.jsp"/>
</body>
</html>
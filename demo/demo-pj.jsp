...
<div class="listBox">
        <div class="listTitle">常用评价<span class="more"><a href="add-train.html">+</a></span></div>
        <div class="list">
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tTitle">
            <tr>
              <td style="width:700px">常用评价</td>
              <td>操作</td>
            </tr>
          </table>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tList" id="list_tb">
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">使用不熟练</td>
              <td class="trainFunction"><a href="#" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">技术不够熟练还需加强培训</td>
              <td class="trainFunction"><a href="#" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>            
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">执行没到位</td>
              <td class="trainFunction"><a href="#" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">非常好</td>
              <td class="trainFunction"><a href="#" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>                        
          </table>
        </div>

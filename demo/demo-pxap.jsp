        ...
        <div class="list">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tList" id="list_tb">
            <tr class="colorGrey">
              ...
              <td class="trainFunction" width="230"><a href="demo-pxap-detail.jsp" class="detail">查看</a><a href="demo-pxap-update.jsp" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>
            <tr class="colorGrey">
              <td width="77" class="trainTime">7月17日</td>
              <td width="76" class="trainAdd">花都区</td>
              ...
              <td width="118" class="trainContent">电缆校直加温</td>
              <td width="40" class="trainContent">未进行</td>
              <td class="trainFunction" width="230"><a href="#" class="detail">查看</a><a href="#" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>
            <tr class="colorGrey">
              <td width="77" class="trainTime">7月17日</td>
              <td width="76" class="trainAdd">花都区</td>

...
<div class="listBox">
        <div class="listTitle">工作内容<span class="more"><a href="add-train.html">+</a></span></div>
        <div class="list">
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tTitle">
            <tr>
              <td style="width:700px">工作内容</td>
              <td>操作</td>
            </tr>
          </table>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tList" id="list_tb">
            <tr class="colorGrey">
              ...
              <td class="trainFunction"><a href="demo-pxap-update.jsp" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">开线加温</td>
              <td class="trainFunction"><a href="demo-pxap-update.jsp" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>            
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">绝缘打磨</td>
              <td class="trainFunction"><a href="demo-pxap-update.jsp" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>
            <tr class="colorGrey">
              <td class="trainTime" style="width:700px">带材绕包</td>
              <td class="trainFunction"><a href="demo-pxap-update.jsp" class="edit">编辑</a><a href="#" class="delete">删除</a></td>
            </tr>                        
          </table>
        </div>

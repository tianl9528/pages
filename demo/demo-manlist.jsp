        ...
        <div class="list">
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tTitle">
            <tr>
              ...
              <td width="200">姓名</td>
              <td>性别</td>
              <td width="200">职务(角色)</td>
              <td width="230">操作</td>
            </tr>
          </table>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tList" id="list_tb">
            <tr class="colorGrey">
              <td class="trainTime" style="width:200px">gzzhangshang</td>
              <td class="trainAdd" style="width:200px">张三</td>
              <td class="trainName">男</td>
              <td class="trainContent" style="width:200px">学员</td>

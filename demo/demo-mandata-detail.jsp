...
<div class="listBox">
        ...
        <div class="list">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tList" id="list_tb">
            <tr class="colorGrey">
              <td class="trainTime" style="width:130px">7月17日</td>
              <td class="trainAdd" style="width:130px">花都区</td>
              <td class="trainName" style="width:450px">110KV大凌至湖畔电缆工程国电四维户外……</td>
              <td class="trainCoach" style="width:130px">刘易斯</td>
              <td class="trainContent" style="width:130px">电缆校直加温</td>
              <td class="trainContent">未进行</td>
              <td class="trainFunction" style="width:80px"><a href="demo-pxap-detail.jsp" class="detail">查看</a></td>
            </tr>
            <tr class="colorGrey">
              ...
              <td class="trainFunction" width="130"><a href="#" class="detail">查看</a></td>
            </tr>
            <tr class="colorGrey">
              <td width="77" class="trainTime">7月17日</td>
              <td width="76" class="trainAdd">花都区</td>
              ...
              <td width="118" class="trainContent">电缆校直加温</td>
              <td width="40" class="trainContent">未进行</td>
              <td class="trainFunction"><a href="#" class="detail">查看</a></td>
            </tr>
            <tr class="colorGrey">
              <td width="77" class="trainTime">7月17日</td>
              <td width="76" class="trainAdd">花都区</td>
              ...
              <td width="118" class="trainContent">电缆校直加温</td>
              <td width="40" class="trainContent">未进行</td>
              <td class="trainFunction" width="230"><a href="#" class="detail">查看</a></td>
            </tr>            
          </table>
        </div>
        <div class="page">

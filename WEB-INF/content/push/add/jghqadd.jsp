...
<script type="text/javascript">
	$(document).ready(function(){
		...
		KindEditor.ready(function(K) {
			editor = K.create('textarea[name="jghq.aicontent"]', {
				resizeType : 1,
...
<div class="panel panel-default">
	<div class="panel-heading">价格行情-新增</div>
		<div class="panel-body">
			<form class="form-horizontal" id="rsssave" action="jghqsave.action" method="post" enctype="multipart/form-data">			
				<div class="form-group">
					<label for="goods" class="col-sm-2 control-label">标题</label>
					<div class="col-sm-6" style="width:200px">
						<input type="text" class="form-control" id="aititle" name="jghq.aititle" placeholder="输入标题">
					</div>
				</div>
				<div class="form-group" >
					<label for="goodsinfo" class="col-sm-2 control-label">来源</label>
					<div class="col-sm-6 input_width1">
						<input type="text" class="form-control" id="airesource" name="jghq.airesource" placeholder="请输入来源">
					</div>
				</div>
				<div class="form-group" >
					<label for="goodsinfo" class="col-sm-2 control-label">日期</label>
					<div class="col-sm-6 input_width1">
						<input type="text" class="form-control" id="aidate" name="jghq.aidate" placeholder="请输入日期">
					</div>
				</div>
				<div class="form-group" >
					<label for="goodsinfo" class="col-sm-2 control-label">内容</label>
					<div class="col-sm-6 input_width1">
						<textarea class="form-control" id="aicontent" name="jghq.aicontent" placeholder="请输入内容" style="width:700px;height:200px;visibility:hidden;"></textarea>
					</div>
				</div>
				<div class="form-group">

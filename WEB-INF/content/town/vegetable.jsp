...
<body>
	<div style="padding: 20px 20px 0 20px;">
		<form action="vegetable.action" method="post">
			<div class="searchBox">
				<!-- <table>
				</select>
				</td>
			...
			<div class="list">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<c:if test="${!empty page.result}">
						<c:forEach items="${page.result}" var="vegetable" varStatus="stat">
							<c:if test="${ vegetable.agriculturethirdtype.agriculturesecondtype.agstypename == '浆果'}">
								<tr
								...
								width="100" height="100" /></td> -->
									...
									<td class="trainLeft" width="100">${vegetable.id}</td>
									<td class="trainContent" width="100">${vegetable.vtype}</td>
									<td class="trainContent" width="100">${vegetable.agriculturethirdtype.agriculturesecondtype.agstypename}</td>
									<td class="trainFunction" width="100"><a
										href="vegetable-details.action?id=${vegetable.id}"
										class="detail">查看</a><a
										href="vegetable-input.action?id=${vegetable.id}" class="edit">编辑</a><a

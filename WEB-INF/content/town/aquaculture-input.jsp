...
<body>
	<div class="clear"></div>
	<form id="form1" name="form1" method="post" action="aquaculture-save.action"
		onSubmit="return checkforminput()">
		<div class="conBox">
			<div class="conTitle">水果信息</div>
			<div class="conMiddle">
				<div>
					<table cFellpadding="0" cellspacing="13" border="0" class="selectTb">
						<tr>
							<td>
								<table cellpadding="0" cellspacing="0" border="0"
									class="contentTB">
									<input name="id" type="hidden" id="id" value="${aquaculture.id }"></input>
									<!-- <tr class="greyColor">
										<td class="typeNameTd" width="110">id</td>
										<td class="memberAddTd" align="left" width="350"><input
											name="aquaculture.id" id="aid" type="text"
											class="itemManagerInput" value="${aquaculture.id }" /></td>
									</tr> -->
									<tr class="whiteColor">
										<td class="typeNameTd" width="110">atype</td>
										<td class="memberAddTd" align="left" width="350"><input
											name="aquaculture.atype" id="ftype" type="text"
											class="itemManagerInput" value="${aquaculture.atype }" /></td>
									</tr>
									<tr class="whiteColor">
										<td class="typeNameTd" width="110">astypeid</td>
										<td class="memberAddTd" align="left" width="350"><input
											name="aquaculture.astypeid" id="astypeid" type="text"
											class="itemManagerInput" value="${aquaculture.astypeid }" /></td>
									</tr>
								</table>
							</td>
						</tr>
				...
				<div class="subBtnBox">
					<input type="submit" class="base_btn" onclick="return check();"
						...
						onclick="window.location.href='aquaculture.action'" />
				</div>
			</div>

					...
					<div class="col-xs-12 col-lg-12" style="">												
						...
						<div class="panel panel-default" style="">
							...
							<div class="panel-body" style="">
								<form action="replyupdate.action?id=${ir.id}" class="form-horizontal" method="post">
									<div class="form-group">
										<div class="col-sm-12">
									      <textarea style="height:180px;" class="form-control" rows="15" id="content" name="ir.reContent" style="height:180px">${ir.reContent}</textarea>
									    </div>
									</div>
									<div class="form-group">

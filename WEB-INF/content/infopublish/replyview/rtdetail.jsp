							...
							<div class="panel-body" style="height:100px;">	
								...
								<div class="row">
									<div class="col-xs-12 xol-lg-12" style="text-align:left;">									
										招聘：${rt.job}&nbsp;人数：${rt.num}&nbsp;截止日期：<fmt:formatDate value="${rt.enddate}"></fmt:formatDate>
									</div>									
								</div>
								...
								<div class="row" style="margin-top:0px;">
									...
									<div class="col-xs-3 xol-lg-3" style="text-align:left;color:#618FC0">
										发布时间：<fmt:formatDate value="${rt.pubdate}"></fmt:formatDate>	
									</div>
								</div>																																																																																																																																						
								</c:if>																											
								<c:if test="${empty rt}">没有数据！</c:if>
							</div>
						</div>
						<div class="panel panel-default" style="">
							<div class="panel-heading" style="text-align:left">

...
<script charset="utf-8" src="<%=request.getContextPath()%>/scripts/kindeditor-4.1.7/kindeditor-min.js"></script>
...
function goBack(){
		window.location="<%=request.getContextPath()%>/article/myArticle-list.action";
}
</script>
...
<form action="<%=request.getContextPath()%>/article/myArticle-update.action" name="myAction" id="myAction" method="post" onsubmit="return checkArticle()">
<input type="hidden" id="articleLId" name="articleId" value="${articleId}">
<div class="conBox">
        <div class="conTitle">文章编辑</div>
        <div class="conMiddle">
          <div>
            <table cellpadding="0" cellspacing="13" border="0" class="selectTb">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="contentTB">
                    ...
                    <tr class="whiteColor">
                      ...
                      <input name="articleTittle" id="articleTittle" type="text" class="itemManagerInput" value="${entity.articleTittle }"/>
                      </td>                    
                    </tr>
                    ...
                    <tr class="greyColor">
                      ...
                      <td align="left">
                      <textarea name="articleContent" id="articleContent" rows="20" style="width:100%">${entity.articleContent}</textarea>
                      </td>
                    </tr>                    
                  </table>

...
<div class="conBox">
            ...
            <table  cellpadding="0" cellspacing="13" border="0" class="selectTb">
                ...
                <table  width="910" cellpadding="0" cellspacing="0" border="0" class="contentTB">
                    ...
                    <tr class="greyColor" >
                     ...
                     ${articleEntity.articleContent}<br>
                      </td>                   
                    </tr>
		...
		<table cellpadding="0" cellspacing="13" border="0" class="selectTb">
         ...
         <form action="artCommentRead-save.action" method="post" onSubmit="checkComment()">
          ...
          <table  width="910" cellpadding="0" cellspacing="0" border="0" class="contentTB">
            ...
            <tr class="greyColor" >
              ...
              <input type="button"  class="base_btn" value="返回" onClick="window.location.href='<%=request.getContextPath()%>/article/article-read.action'"/></td>                   
            </tr>

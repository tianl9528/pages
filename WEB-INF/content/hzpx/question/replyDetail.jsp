...
function deleteConfirm(replyId,questionId){
		if(confirm("确定要删除吗？")){
			window.location="<%=request.getContextPath()%>/question/reply-delete.action?replyId="+replyId+"&questionId="+questionId;
		}
}
</script>
<script>
...
<div class="conBox">
				         ...
				         <div class="post_conent_d1">
				          ...
				          <div class="post_content_d2">
				           ...
				           <fmt:formatDate value="${reply.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/></span>				           
				            ...
				            <a href="#"  onClick="deleteConfirm('${reply.id}','${questionId}')" >删除</a></c:if>
				            </span> 
				           </p>
 ...
 <form action="reply-save.action" method="post" onSubmit="return checkComment()">
         <input type="hidden" name="questionId" value="${questionId}">
          ...
          <table  width="910" cellpadding="0" cellspacing="0" border="0" class="contentTB">
            ...
            <tr class="greyColor" >
		      ...
		      <input type="button"  class="base_btn" value="返回" onClick="window.location.href='<%=request.getContextPath()%>/question/question-list.action'"/>
            </tr>

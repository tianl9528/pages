...
function goBack(){
		window.location="<%=request.getContextPath()%>/question/question-list.action";
}
</script>
...
<form action="<%=request.getContextPath()%>/question/myQuestion-update.action" name="myAction" id="myAction" method="post" onsubmit="return checkQuestion()">
<input type="hidden" id="questionId" name="questionId" value="${questionId}">
<div class="conBox">
        <div class="conTitle">问题编辑</div>
        <div class="conMiddle">
          <div>
            <table cellpadding="0" cellspacing="13" border="0" class="selectTb">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="contentTB">
                    ...
                    <tr class="whiteColor">
                      ...
                      <input name="questionTittle" id="questionTittle" type="text" class="itemManagerInput" value="${entity.questionTittle }"/>
                      </td>                    
                    </tr>
                    ...
                    <tr class="greyColor">
                      ...
                      <td align="left">
                      <textarea name="questionContent" id="questionContent" rows="20" style="width:100%">${entity.questionContent}</textarea>
                      </td>
                    </tr>                    
                  </table>

						...
						<div class="panel-body" style="padding: 0 15px 0 15px;">
							<div class="row">
								<div class="col-xs-8 col-lg-8" style="padding: 0 0 0 10px;">
									<a
										href="http://jgsb.agri.gov.cn/controller?SERVICE_ID=REGISTRY_JCSJ_MRHQ_SHOW_SERVICE&recordperpage=15&newsearch=true&login_result_sign=nologin"
										target="_blank"><img
										src="<%=request.getContextPath()%>/theme/image/pifashichang.png"
										" style=" height: 180px;" alt="农产品图片"></a>
								</div>

		...
		<div class="page">
			<div class="pageBox">
				<table border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td><c:if test="${!empty page_searchresult.result}">${controlTable_searchresult}</c:if></td>
					</tr>
				</table>
			</div>
		</div>

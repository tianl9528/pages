...
<body style="background: none;">
	<div style="max-width: 970px; min-width: 720px; padding: 20px 0 0 10px;">
		<div class="panel panel-default">
			<div class="panel-heading">信息录入</div>
			<div style="margin-top: 20px">
				<form class="form-horizontal" id="#" role="form"
					action="articleNewsupdate.action?articleID=${articleNews.id}"
					method="post">
					...
					<div class="row" style="margin: 0">
						<!-- 	<div class="form-group">
							<label for="tecsource" class="col-lg-2 col-xs-2 control-label"
								style="text-align: right">信息类型</label>
							<div class="col-lg-4 col-xs-4">
								<input type="text" class="form-control" id="tecsource"
									placeholder="信息类型" name="articleNews.atype"
									value="${articleNews.atype}" />
							</div>
						</div> -->
						<div class="form-group">
							...
							<input type="text" class="form-control" id="tecsource"
								...
								<%-- <select id="ObjectCategorytype1" name="articleNews.atype"
									class="form-control rightleg" disabled="disabled">
									<option value="${articleNews.atype }" >请选择</option>
									...
									<option value="通知通报" selected="selected">通知通报</option>
					...
					<div class="form-group">
						...
						<div class="col-lg-6 col-xs-6">
							<textarea class="form-control" rows="9" id="tecinfo"
								...
								style="height: 100px">${articleNews.acontent }</textarea>
						</div>
					</div>
					<div class="form-group ">
						<div class="col-lg-6 col-lg-offset-4 col-xs-6 col-xs-offset-4">
							<button type="submit" class="btn btn-success col-lg-2 col-xs-2">更新</button>

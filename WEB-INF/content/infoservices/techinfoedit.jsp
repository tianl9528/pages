		...
		<div class="panel panel-default">
			...
			<div style="margin-top: 20px">
				<form class="form-horizontal" id="#" role="form"
					action="techinfoupdate.action?techNewsID=${techNews.iid}"
					method="post">
						...
						<div class="form-group">
							...
							<div class="col-lg-4 col-xs-4">
								<select id="tecfield" name="techNews.istypeid"
									class="form-control ">
									<option value="${techNews.istypeid}" selected="selected">请选择</option>
					...
					<div class="row" style="margin: 0">
						<div class="form-group">
							<label for="tecfield" class="col-lg-2 col-xs-2 control-label" style="text-align: right">农产品类别</label>
							<div class="col-lg-4 col-xs-4">
					...
					<div class="form-group">
						...
						<div class="col-lg-6 col-xs-6">
							<textarea class="form-control" rows="9" id="tecinfo"
								...
								style="height: 100px">${techNews.icontent}</textarea>
						</div>
					</div>
					<div class="form-group ">

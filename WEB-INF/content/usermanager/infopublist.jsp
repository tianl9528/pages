		...
		<div class="">
			<div class="col-lg-2 col-xs-2">
				<div class="col-lg-12 col-xs-12">
					<div class="panel-group" id="accordion">
						<div class="panel panel-default" style="margin: 15px 0 0 0;width: 165px">
							...
							<div class="panel-body">
								<div class="tabbable">
									<ul class="nav bs-sidenav" id="tabTit">
										...
										<li><a href="#" onclick="go('model10.action');">企业快讯</a></li>
										<li><a href="#" onclick="go('model11.action');">培训资讯</a></li>
										<li><a href="#" onclick="go('model12.action');">技术提问</a></li>
									</ul>
								</div>
							</div>
						</div>
			...
			<div class="col-lg-10 col-xs-10">
				<div class="tab-content col-lg-12 col-xs-12"
					style="padding: 0px 0 0 10px;margin-left: 10px;">
					<iframe class='con' src="model1.action" frameborder="0" id="tabCon" scrolling="no" style="width:780px;height:500px;margin-top:15px;margin-left:8px;"></iframe>
				</div>

									...
									<c:if test="${!empty page_js.result}">
										<c:forEach items="${page_js.result}" var="js"
											...
											<tr
												...
												<td class="trainLeft" width="40"><a href="<%=base_root%>/infoExchange/jsdetail.action?id=${js.user.user_id }" target="_blank" class="active">求职&nbsp;${js.expjob}</a></td>
												<td class="trainLeft" width="40" style="font-size:12px;">${js.applyername}</td>
												<td class="trainLeft" width="40" style="font-size:12px;"><fmt:formatDate value="${js.apppubdate}"></fmt:formatDate></td>
												<td class="trainFunction" width="80">
												<a href="<%=base_root%>/infoExchange/jsdetail.action?id=${js.user.user_id }" target="_blank" class="detail">查看</a>
												<a href="jsedit.action?id=${js.user.user_id}" target="_blank" class="edit">编辑</a> 

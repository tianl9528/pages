...
<div class="panel panel-default">
	<div class="panel-heading">编辑农产品供应信息</div>
		<div class="panel-body">
			<form class="form-horizontal" id="prosupform" role="form" action="psupdate.action?proSupID=${prosupp.id}" method="post" enctype="multipart/form-data">
				<div class="row">

...
<body>
	<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" role="form" action="<%=base_root%>/infopublish/jsupdate.action?id=${js.user.user_id}" enctype="multipart/form-data" method="post">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 " style="padding:15px 0 10px 30px">
										<button type="submit" onclick="return checkJobseek(this);" class="btn btn-success col-sm-3" style="width:80px">修改</button>

					...
					<div class="col-xs-12 col-lg-12" style="">												
						<div class="panel panel-default" style="">
							...
							<div class="panel-body">	
								...
								<div class="content">
									<form class="form-horizontal" id="quesform" action="tqupdate.action?id=${opq.id}" method="post">
									  ...
									  <div class="form-group">
										<div class="col-sm-offset-2 " style="padding:15px 0 10px 30px">
											<button type="submit" class="btn btn-success col-sm-3" style="width:80px" onclick="#">修改</button>

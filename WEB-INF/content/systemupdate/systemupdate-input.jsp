...
<form name="thisForm" method="post" action="systemupdate-save.action" onSubmit="return checkforminput()">	
	...
	<tr>
      ...
      <tr>
       ...
       <textarea name="systemupdate.module" cols=50 rows=3 id="module" >${systemupdate.module}</textarea>
    ...
    <tr>
      ...
      <td class="title_left" width="10%" style="text-align: center;">状态</td>
       <td class="content" style="text-align:left;">
      <select name="state" id="state_id">  
                      <option value="0" <c:if test="${systemupdate.state=='0' || empty id}">selected</c:if>>未确定</option>
                      <option value="1" <c:if test="${systemupdate.state=='1'}">selected</c:if>>已确定</option>
           		 </select> 
      </td>
      </tr> 

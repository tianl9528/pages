...
<script type="text/javascript">
	$(document).ready(function(){
		$("#select").change(function(){
			...
			window.location.href="/gdzyzmm/infoExchange/investlist.action?orderway="+orderway;
		});
	});
</script>
<script type="text/javascript">
...
<body> 
	<div style="max-width:1007px;min-width:970px;margin:0 auto">
		...
		<div id="tip2" title="提示" style="display:none;">
			<p>您当前的身份是${user_role}，不能发布招商代理信息</p>
		</div>
				  ...
				  <div class="" id="default">
		            	<table class="table table-striped">
		                    ...
		                    <tbody class="">
		            			...
		            			<tr>
		           					<td width="70%"><a href="investdetail.action?id=${invest.id}&investerid=${invest.user.user_id}" class="active">招商：&nbsp;${invest.inName}</a></td>           			
		           					<td width="10%">${invest.user.user_name}</td>
		           					<td width="10%"><fmt:formatDate value="${invest.inPubDate}"></fmt:formatDate></td>
		           					<td width="10%">${invest.recount}</td>            					
		            			</tr>
		            			</c:forEach>
				 				</c:if>     
		                    </tbody>  

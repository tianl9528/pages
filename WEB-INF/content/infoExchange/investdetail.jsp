...
<body> 
	<div style="max-width:1007px;min-width:970px;margin:0 auto">
		...
		<div>
			<form action="investreply-save.action" name="myAction" id="myAction" method="post" onsubmit="#">
				<div class="conBox">
					<input type="hidden" name="infore.parentId" id="parentid"  value="${invest.id}" />
					<input type="hidden" name="infore.reType" id="techsuppretype"  value="招商" />

...
<body> 
			...
			<div class="panel-heading"
				...
				<div class="row">
					...
					<div class="col-xs-2 col-lg-2">
						<a href="prosuplist.action">返回上一级</a>
					</div>
				</div>	
			</div>
	...
	<div>
		<form action="prosupreply-save.action" name="myAction" id="myAction" method="post" onsubmit="#">
			<div class="conBox">
				<input type="hidden" name="infore.parentId" id="parentid"  value="${prosup.id}" />
				<input type="hidden" name="infore.reType" id="techsuppretype"  value="农产品供应" />

...
<body> 
	<div style="max-width:1007px;min-width:970px;margin:0 auto">
			...
			<div class="panel-heading"
				...
				<div class="row">
					...
					<div class="col-xs-2 col-lg-2">
						<a href="logisupplist.action">返回上一级</a>
					</div>
				</div>	
			</div>
				...
				<div class="col-xs-8 col-lg-8" style="margin-top:5px">
					<div class="row"  style="height:220px;">
						...
						<div class="col-xs-6 col-lg-6" style="padding: 0 10px 0 0;">
							<table class="table">
								<tbody>
									<tr>
										<td>出发地</td><td>${logisupp.startPlace}</td>
									</tr>
									<tr>
										<td>到达地</td><td>${logisupp.arrivePlace}</td>
									</tr>
									<tr>
										<td>途经地</td><td>${logisupp.wayPoint}</td>
									</tr>
									<tr>
										<td>价格</td><td>￥${logisupp.lsPrice}</td>
									</tr>
									<tr>
										<td>车辆识别码</td><td>${logisupp.identiCode}</td>
									</tr>
									<tr>
										<td>发车时间</td><td><fmt:formatDate value="${logisupp.departureTime}"></fmt:formatDate></td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="row" style="padding:10px;">
						<table class="table">
							<tbody>
								<tr>
									<td width="30%">说明</td><td width="70%">${logisupp.explanation}</td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div>
			<form action="logisuppreply-save.action" name="myAction" id="myAction" method="post" onsubmit="#">
				<div class="conBox">
					<input type="hidden" name="infore.parentId" id="parentid"  value="${logisupp.id}" />
					<input type="hidden" name="infore.reType" id="retype"  value="物流供应" />

					...
					<div class="col-xs-12 col-lg-12" style="">												
						...
						<div class="panel panel-default" style="">
							...
							<div class="panel-body" style="height:250px;">
								<form class="form-horizontal" role="form" action="expansupdate.action?id=${tqr.id}" method="post">
									<div class="form-group">
									    <div class="col-sm-12">
									      <textarea style="height:180px;" class="form-control" rows="15" id="content" name="tqr.content" style="height:180px">${tqr.content}</textarea>
									    </div>

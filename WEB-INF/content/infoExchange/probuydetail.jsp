...
<body> 
	<div style="max-width:1007px;min-width:970px;margin:0 auto">
			...
			<div class="panel-heading"
				...
				<div class="row">
					...
					<div class="col-xs-2 col-lg-2">
						<a href="probuylist.action">返回上一级</a>
					</div>
				</div>	
			</div>
		...
		<div>
		<form action="probuyreply-save.action" name="myAction" id="myAction" method="post" onsubmit="#">
			<div class="conBox">
				<input type="hidden" name="infore.parentId" id="parentid"  value="${probuy.id}" />
				<input type="hidden" name="infore.reType" id="retype"  value="农产品需求" />

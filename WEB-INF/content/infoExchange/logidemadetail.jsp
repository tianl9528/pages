...
<body> 
	<div style="max-width:1007px;min-width:970px;margin:0 auto">
		...
		<div>
			<form action="logidemareply-save.action" name="myAction" id="myAction" method="post" onsubmit="#">
				<div class="conBox">
					<input type="hidden" name="infore.parentId" id="parentid"  value="${logidema.id}" />
					<input type="hidden" name="infore.reType" id="retype"  value="物流需求" />

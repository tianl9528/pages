...
<title>工作类型管理 - <%=request.getParameter("id")==null?"新增":"修改" %></title>
<%
...
<form id="form1" name="form1" method="post" action="worktype-save.action?id=${workType.id}" onSubmit="return checkforminput()">	
<div class="conBox">
        <div class="conTitle">工作类型</div>
        <div class="conMiddle">
          <table cellpadding="0" cellspacing="13" border="0" class="selectTb">
              ...
              <td>
                <table cellpadding="0" cellspacing="0" border="0" class="contentTB">
                    <tr class="greyColor">
                      <td class="typeNameTd" style="width:150px">工作类型</td>
                      <td class="memberAddTd" align="left" style="width:720px"><input name="workType.typeName" type="text" class="itemManagerInput_m" id="user.user_name" value="${workType.typeName}" />  </td>
                    </tr>
                     <tr class="whiteColor">
                       <td class="typeNameTd">备注</td>
                       <td class="memberAddTd" align="left">
                       <input name="workType.remark" class="itemManagerInput" type="text" value="${workType.remark}"/></td>
                   </tr>
              </table>
          </td>
              </tr>
        ...
        <input type="button"  class="base_btn" value="返回" onclick="window.location.href='worktype.action'"/>
          </div>

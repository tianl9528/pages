		...
		<div class="panel panel-default">
			...
			<div style="margin-top: 20px">
				<form class="form-horizontal" id="#" role="form"
					action="detectservupdate.action?id=${serv.id}" method="post"
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="服务名称" name="serv.sname"
									value="${serv.sname }" /></td>
							</tr>
							<tr>
								<th>单位名称：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="单位名称" name="serv.sinstname "
									value="${serv.sinstname }" /></td>
							</tr>
							<tr>
								<th>简介：</th>
								<td colspan="3"><input type="text" class="form-control"
							...
							<tr>
								<th>服务类别：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="服务类别" name="serv.stype"
									value="${serv.stype }" /></td>
							</tr>
							...
							<tr>
								...
								<td colspan="3"><textarea class="form-control" rows="9" id="tecinfo"
										placeholder="服务内容描述" name="serv.scontent"
										style="height: 100px" >${serv.scontent }</textarea></td>
							</tr>
							<tr>
								<th style="padding: 0px 5px 0px 5px;">服务流程说明：</th>
								<td colspan="3">
								<textarea class="form-control" rows="9" id="tecinfo"
										placeholder="服务流程说明" name="serv.sstream"
										style="height: 100px">${serv.sstream }</textarea></td>
							</tr>
							<tr>
								<th>服务时间：</th>
							...
							<tr>
								...
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="服务方式" name="serv.smethod"
									value="${serv.smethod }" /></td>
								<th>关键字：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="关键字" name="serv.skeyword"
									value="${serv.skeyword }" /></td>
							</tr>
							...
							<tr>
								<th>联系人：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="联系人" name="serv.scontact "
									value="${serv.scontact }" /></td>
								<th width="15%">联系电话：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="联系电话" name="serv.sphone"
									value="${serv.sphone }" /></td>
							</tr>

							<tr>
								<th>手机：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="手机" name="serv.smobile"
									value="${serv.smobile }" /></td>
								<th>电子邮箱：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="电子邮箱" name="serv.semail"
									value="${serv.semail }" /></td>
							</tr>

							<tr>
								<th>地址：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="地址" name="serv.saddress"
									value="${serv.saddress }" /></td>
								<th>邮编：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="邮编" name="serv.spostcode"
									value="${serv.spostcode }" /></td>
							</tr>

							<tr>
								<th>传真：</th>
								<td><input type="text" class="form-control" id="tecfield"
									placeholder="传真" name="serv.sfax" value="${serv.sfax }" /></td>
								<th>附件：</th>
								<td>
									<div>
										<input type="text" class="form-control" id="tecfield"
											placeholder="附件" name="serv.sadd" value="${serv.sadd }" />
									</div>
								</td>
							</tr>

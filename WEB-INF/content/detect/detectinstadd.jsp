		...
		<div class="panel panel-default">
			...
			<div style="margin-top: 20px" >
				<form class="form-horizontal" id="#" role="form"
					action="detectinstsave.action" method="post"
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="机构名称" name="inst.dname" /></td>
							</tr>
							<tr>
								<th>机构类型：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="机构类型" name="inst.dtype" /></td>
							</tr>
							<tr>
								<th>机构简介：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="机构简介" name="inst.dintroduce" /></td>
							</tr>
							<tr>
								<th>服务内容：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="服务内容" name="inst.dservice" /></td>
							</tr>
							<tr>
								<th>产品或成果(介绍)：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="产品或成果(介绍)" name="inst.dproduct" /></td>
							</tr>
							<tr>
								<th>相关团队(介绍)：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="相关团队(介绍)" name="inst.dteam" /></td>
							</tr>
							<tr>
								<th>特色资源(介绍) ：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="特色资源(介绍) " name="inst.dresource" /></td>
							</tr>
							<tr>
								<th>项目或课题(描述)：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="项目或课题(描述)" name="inst.dproject" /></td>
							</tr>
							<tr>
								<th>关键字：</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="关键字" name="inst.dkeyword" /></td>
							</tr>
							<tr>
								<th colspan="4">
									<h4>&nbsp;</h4>
							...
							<tr>
								...
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="手机" name="inst.dmobile" /></td>
								<th>电子邮箱：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="电子邮箱" name="inst.demail" /></td>
							</tr>
							<tr>
								<th>地址：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="地址" name="inst.daddress" /></td>
								<th>邮编：</th>
								<td colspan="1"><input type="text" class="form-control"
									id="tecfield" placeholder="邮编" name="inst.dpostcode" /></td>
							</tr>
							<tr>
								<th>机构图片或logo：</th>
								<td colspan="3">
							<tr class="greyColor">
								...
								<td class="memberAddTd" align="left" colspan="3"><img
									class="img-thumbnail" src="<%=request.getContextPath()%>#"

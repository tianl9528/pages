		...
		<div class="panel panel-default">
			...
			<div style="margin-top: 20px">
				<form class="form-horizontal" id="#" role="form"
					action="detectlawupdate.action?id=${law.id}" method="post"
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3"><textarea class="form-control" rows="9" id="tecinfo"
										...
										style="height: 100px" >${law.ldetail  }</textarea></td>
							</tr>
							...
							<tr>
								<th>所属分类</th>
								<td colspan="3"><input type="text" class="form-control"
									id="tecfield" placeholder="法规名称" name="law.lclassfy"
									value="${law.lclassfy }" /></td>
							</tr>
							<tr>
								<th>所属栏目：</th>
								<td colspan="3"><input type="text" class="form-control"

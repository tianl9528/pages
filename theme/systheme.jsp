...
<img src="<%=base_root%>/theme/images/white.png" alt=""  style="width: 100px;height: 20px;z-index: 10;margin-left: -280px;margin-top: 41px;" />                                <div style="float: right; padding-top: 5px; margin-right: 5px;">
                                    <p>欢迎回来</p>
                                    <p>
